  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-[800px] overflow-hidden rounded-2xl bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between border-b border-[#D0D5DD] lg:px-6 px-4 xl:py-5 py-4">
        ...
        <div className="lg:p-6 p-4">
          <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full h-11 px-4 rounded-xl border ${errors.startDate ? 'border-red-500' : 'border-neutral-200'} lg:text-[14px] text-[12px] outline-none focus:border-[#257BFC] focus:ring-1 focus:ring-[#257BFC] transition-all`}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full h-11 px-4 rounded-xl border ${errors.endDate ? 'border-red-500' : 'border-neutral-200'} lg:text-[14px] text-[12px] outline-none focus:border-[#257BFC] focus:ring-1 focus:ring-[#257BFC] transition-all`}
                  />
                </div>
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full h-24 p-4 rounded-xl border ${errors.reason ? 'border-red-500' : 'border-neutral-200'} lg:text-[14px] text-[12px] outline-none focus:border-[#257BFC] focus:ring-1 focus:ring-[#257BFC] transition-all resize-none`}
              ></textarea>
          ...
          <div className="mt-8 flex items-center justify-end gap-3">
            <button
              onClick={onClose}
              className="lg:h-10 h-9 lg:px-6 px-4 rounded-xl border border-black lg:text-[14px] text-[12px] font-semibold text-black cursor-pointer"
            >
              Cancel
            </button>
            <button
              onClick={handleSubmit}
              className="lg:h-10 h-9 lg:px-6 px-4 rounded-xl bg-[#257BFC] lg:text-[14px] text-[12px] font-semibold text-white cursor-pointer"
            >
              Submit Request
            </button>
          </div>
