...
export default function Toast({ show, message, onClose }: ToastProps) {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-[9999] flex items-center gap-3 w-max md:max-w-[calc(100vw-3rem)] max-w-[calc(100vw-1rem)] rounded-xl border border-[#D1FADF] bg-[#F6FBF6] px-5 py-3 shadow-sm transition-all duration-300 ease-in-out ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-[120%] opacity-0'}`}>
