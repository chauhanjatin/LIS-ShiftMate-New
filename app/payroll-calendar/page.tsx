                        ...
                        <table className="min-w-[1000px] w-full text-left">
                            <thead className="bg-white">
                                <tr>
                                    ...
                                    <th className="border-b border-[#D0D5DD] py-3 sm:py-4 pr-4 text-[12px] sm:text-[14px] font-semibold text-neutral-900">Start Date</th>
                                    <th className="border-b border-[#D0D5DD] py-3 sm:py-4 pr-4 text-[12px] sm:text-[14px] font-semibold text-neutral-900">End Date</th>
                                    <th className="border-b border-[#D0D5DD] py-3 sm:py-4 pr-4 text-[12px] sm:text-[14px] font-semibold text-neutral-900">Pay Date</th>
                                    <th className="border-b border-[#D0D5DD] py-3 sm:py-4 pr-4 text-[12px] sm:text-[14px] font-semibold text-neutral-900">Status</th>
                                    <th className="border-b border-[#D0D5DD] py-3 sm:py-4 pr-4 text-[12px] sm:text-[14px] font-semibold text-neutral-900">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                {filteredCalendars.map((cal) => (
                                    <tr key={cal.id} className="group transition-colors hover:bg-neutral-50">
                                        <td className="border-b border-[#D0D5DD] py-4 pr-6 text-[13px] sm:text-[14px] font-medium text-neutral-900">{cal.payPeriod}</td>
                                        <td className="border-b border-[#D0D5DD] py-4 pr-6 text-[13px] sm:text-[14px] font-medium text-neutral-900">{cal.startDate}</td>
                                        <td className="border-b border-[#D0D5DD] py-4 pr-6 text-[13px] sm:text-[14px] font-medium text-neutral-900">{cal.endDate}</td>
                                        <td className="border-b border-[#D0D5DD] py-4 pr-6 text-[13px] sm:text-[14px] font-medium text-neutral-900">{cal.payDate}</td>
                                        <td className="border-b border-[#D0D5DD] py-4 pr-6"><StatusPill status={cal.status} /></td>
