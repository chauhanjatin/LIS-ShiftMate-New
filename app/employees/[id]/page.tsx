        ...
        <div className="flex flex-col xl:flex-row 2xl:gap-[34px] gap-[28px] bg-white 2xl:p-6 p-4 rounded-[20px] min-h-[800px]">
          ...
          <div className="w-full 2xl:w-[353px] xl:w-[320px] shrink-0">
            ...
            <div className="mt-8 flex flex-col 2xl:gap-6 gap-4">
              <div>
                <p className="text-[14px] font-normal text-[#9CA3AF] mb-1 m-0">Employee ID</p>
                <p className="text-[20px] font-medium text-[#111827] mt-1 m-0">{employee.id}</p>
              </div>
              <div>
                <p className="text-[14px] font-normal text-[#9CA3AF] mb-1 m-0">Department</p>
                <p className="text-[20px] font-medium text-[#111827] mt-1 m-0">{employee.dept}</p>
              </div>
              <div>
                <p className="text-[14px] font-normal text-[#9CA3AF] mb-1 m-0">Join Date</p>
                <p className="text-[20px] font-medium text-[#111827] mt-1 m-0">{employee.joinDate}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 min-w-[300px] flex flex-col">
            <div className="flex items-center 2xl:gap-1 gap-2 justify-between overflow-x-auto mb-8 bg-[#F9FAFB] p-1.5 rounded-xl scrollbar-hide w-full shrink-0">
              {TABS.map(tab => (
                <button
                  key={tab}
            ...
            <div className="flex-1">
              ...
              {activeTab === "Personal Info" && (
                <div className="w-full">
                  <h3 className="text-[20px] font-bold text-[#111827] mb-6 m-0">Personal Info</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 2xl:gap-x-8 gap-x-6 2xl:gap-y-6 gap-y-5">
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">First name</label>
                      <input type="text" name="firstName" value={formData.firstName} onChange={handleInputChange} className="w-full rounded-xl border border-[#E5E7EB] px-4 py-3 text-[14px] text-[#111827] outline-none box-border focus:border-brand-500 transition-colors" />
                    ...
                    <div className="relative">
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Date of Birth</label>
                      <input type="text" name="dob" value={formData.dob} onChange={handleInputChange} className="w-full rounded-xl border border-[#E5E7EB] px-4 py-3 pr-10 text-[14px] text-[#111827] outline-none box-border focus:border-brand-500 transition-colors" />
                      <svg className="absolute right-4 top-[38px] text-[#6B7280]" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                    </div>
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Gender</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Phone</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Email</label>
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} className="w-full rounded-xl border border-[#E5E7EB] px-4 py-3 text-[14px] text-[#111827] outline-none box-border focus:border-brand-500 transition-colors" />
                    </div>
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Address</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Emergency Contact</label>
              ...
              {activeTab === "Employment Details" && (
                <div className="w-full">
                  <h3 className="text-[20px] font-bold text-[#111827] mb-6 m-0">Employment Details</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 2xl:gap-x-8 gap-x-6 2xl:gap-y-6 gap-y-5">
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Employee ID</label>
                    ...
                    <div className="relative">
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Start Date</label>
                      <input type="text" name="startDate" value={formData.startDate} onChange={handleInputChange} className="w-full rounded-xl border border-[#E5E7EB] px-4 py-3 pr-10 text-[14px] text-[#111827] outline-none box-border focus:border-brand-500 transition-colors" />
                      <svg className="absolute right-4 top-[38px] text-[#6B7280]" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                    </div>
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Employment Type</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Job Title</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Location</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Manager</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Contract Type</label>
              ...
              {activeTab === "Payroll Information" && (
                <div className="w-full">
                  <h3 className="text-[20px] font-bold text-[#111827] mb-6 m-0">Payroll Information</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 2xl:gap-x-8 gap-x-6 2xl:gap-y-6 gap-y-5">
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Bank Account Number</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Sort Code</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">NI Number</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Tax Code</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Payroll Frequency</label>
                    ...
                    <div>
                      <label className="block mb-2 text-[13px] font-medium text-[#111827]">Salary / Hourly Rate</label>
              ...
              {activeTab === "Documents" && (
                <div className="w-full">
                  <h3 className="text-[20px] font-bold text-[#111827] mb-6 m-0">Documents</h3>
                  <div className="rounded-xl border border-[#E2E8F0] bg-white overflow-hidden">
                    <table className="w-full text-left border-collapse">
                      <thead className="bg-[#F8F9FC]">
                        <tr>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 2xl:pl-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">File Name</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Uploaded By</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Expiry Date</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 pr-6 text-[12px] sm:text-[14px] font-medium text-[#111827] text-right">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          ...
                          <tr key={i} className="hover:bg-neutral-50 border-b border-[#E2E8F0] last:border-b-0">
                            <td 
                              className="px-4 py-4 sm:px-6 2xl:pl-6 text-[14px] text-[#111827] flex items-center gap-2 cursor-pointer"
                              onClick={() => setSelectedDocument(doc)}
                            >
                              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6B7280" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                              {doc.name}
                            </td>
                            <td className="px-4 py-4 sm:px-6 text-[14px] text-[#6B7280]">{doc.uploader}</td>
                            <td className="px-4 py-4 sm:px-6 text-[14px] text-[#6B7280]">{doc.date}</td>
                            <td className="px-4 py-4 sm:px-6 pr-6">
                              <div className="flex justify-end gap-3">
                                ...
                                <button className="text-[#6B7280] hover:text-red-500">
                                  <Image src={deleteIcon} alt="Delete" width={18} height={18} className="pointer-events-none" />
                                </button>
                              </div>
                            </td>
                          </tr>
              ...
              {activeTab === "Leave" && (
                <div className="w-full">
                  <h3 className="text-[20px] font-bold text-[#111827] mb-6 m-0">Leaves</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="rounded-xl border border-[#E2E8F0] p-5 flex items-center justify-between shadow-sm">
                      <div>
                        <p className="text-[13px] text-[#6B7280] mb-2">Annual Leave</p>
                        <div className="flex items-end gap-1">
                          <span className="text-[28px] font-bold text-[#111827] leading-none">16</span>
                          <span className="text-[12px] text-[#9CA3AF] mb-1">/ 28 days left</span>
                        </div>
                      </div>
                      <div className="h-12 w-12 rounded-xl bg-[#4DB949] text-white flex items-center justify-center">
                    ...
                    <div className="rounded-xl border border-[#E2E8F0] p-5 flex items-center justify-between shadow-sm">
                      <div>
                        <p className="text-[13px] text-[#6B7280] mb-2">Sick Leave</p>
                        <div className="flex items-end gap-1">
                          <span className="text-[28px] font-bold text-[#111827] leading-none">8</span>
                          <span className="text-[12px] text-[#9CA3AF] mb-1">/ 10 days left</span>
                        </div>
                      </div>
                      <div className="h-12 w-12 rounded-xl bg-[#3B82F6] text-white flex items-center justify-center">
                    ...
                    <div className="rounded-xl border border-[#E2E8F0] p-5 flex items-center justify-between shadow-sm">
                      <div>
                        <p className="text-[13px] text-[#6B7280] mb-2">Pending</p>
                        <div className="flex items-end gap-1">
                          <span className="text-[28px] font-bold text-[#111827] leading-none">01</span>
                        </div>
                      </div>
                      <div className="h-12 w-12 rounded-xl bg-[#F59E0B] text-white flex items-center justify-center">
                  ...
                  <div className="rounded-xl border border-[#E2E8F0] bg-white overflow-hidden">
                    <table className="w-full text-left border-collapse">
                      <thead className="bg-[#F8F9FC]">
                        <tr>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 2xl:pl-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Leave Type</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Start Date</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">End Date</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Total Days</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 pr-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Status</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          ...
                          <tr key={i} className="hover:bg-neutral-50 border-b border-[#E2E8F0] last:border-b-0">
                            <td className="px-4 py-5 sm:px-6 2xl:pl-6 text-[14px] text-[#6B7280]">{leave.type}</td>
                            <td className="px-4 py-5 sm:px-6 text-[14px] text-[#6B7280]">{leave.start}</td>
                            <td className="px-4 py-5 sm:px-6 text-[14px] text-[#6B7280]">{leave.end}</td>
                            <td className="px-4 py-5 sm:px-6 text-[14px] text-[#6B7280]">{leave.days}</td>
                            <td className="px-4 py-5 sm:px-6 pr-6">
                              <span className={`inline-flex rounded-full px-4 py-1 text-[12px] font-medium ${leave.statusColor}`}>
                                {leave.status}
                              </span>
                            </td>
                          </tr>
              ...
              {activeTab === "Audit Log" && (
                <div className="w-full">
                  <h3 className="text-[20px] font-bold text-[#111827] mb-6 m-0">Audit Log</h3>
                  <div className="rounded-xl border border-[#E2E8F0] bg-white overflow-hidden">
                    <table className="w-full text-left border-collapse">
                      <thead className="bg-[#F8F9FC]">
                        <tr>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 2xl:pl-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Date</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Name</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Details</th>
                          <th className="border-b border-[#E2E8F0] px-4 py-4 sm:px-6 pr-6 text-[12px] sm:text-[14px] font-medium text-[#111827]">Status</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          ...
                          <tr key={i} className="hover:bg-neutral-50 border-b border-[#E2E8F0] last:border-b-0">
                            <td className="px-4 py-5 sm:px-6 2xl:pl-6 text-[14px] text-[#6B7280]">{log.date}</td>
                            <td className="px-4 py-5 sm:px-6 text-[14px] text-[#111827]">
                              <div className="flex items-center gap-3">
                                <img src={log.avatar} alt={log.name} className="w-8 h-8 rounded-full object-cover" />
                                {log.name}
                              </div>
                            </td>
                            <td className="px-4 py-5 sm:px-6 text-[14px] text-[#6B7280]">{log.details}</td>
                            <td className="px-4 py-5 sm:px-6 pr-6">
                              <span className={`inline-flex rounded-full px-4 py-1 text-[12px] font-medium ${log.statusColor}`}>
                                {log.status}
                              </span>
                            </td>
                          </tr>
