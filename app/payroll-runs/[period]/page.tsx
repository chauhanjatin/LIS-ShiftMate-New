        ...
        <DashboardLayout title="Payroll Runs" subtitle={breadcrumb}>
            <div className={`flex-1 p-4 2xl:p-6 ${lexendDeca.className}`}>
                <div className="rounded-2xl bg-white p-6">
                    <h3 className="text-[20px] font-medium text-[#101828] mb-4">Payroll Run Details - {period}</h3>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 mb-6">
                        <div className="rounded-2xl border border-[#D0D5DD] bg-white p-5 flex items-center justify-between overflow-hidden">
                            <div>
                                <h3 className="text-[32px] font-semibold text-[#111827]">5</h3>
                                <p className="mt-2 text-[14px] font-medium text-[#111827]">Employees Included</p>
                            </div>
                        ...
                        <div className="rounded-2xl border border-[#D0D5DD] bg-white p-5 flex items-center justify-between overflow-hidden">
                            <div>
                                <h3 className="text-[32px] font-semibold text-[#111827]">$122,500</h3>
                                <p className="mt-2 text-[14px] font-medium text-[#111827]">Total Gross Pay</p>
                            </div>
                        ...
                        <div className="rounded-2xl border border-[#D0D5DD] bg-white p-5 flex items-center justify-between overflow-hidden">
                            <div>
                                <h3 className="text-[32px] font-semibold text-[#111827]">$11712.49</h3>
                                <p className="mt-2 text-[14px] font-medium text-[#111827]">Total Deductions</p>
                            </div>
                        ...
                        <div className="rounded-2xl border border-[#D0D5DD] bg-white p-5 flex items-center justify-between overflow-hidden">
                            <div>
                                <h3 className="text-[32px] font-semibold text-[#111827]">$23037.51</h3>
                                <p className="mt-2 text-[14px] font-medium text-[#111827]">Total Net Pay</p>
                            </div>
                        ...
                        <div className="flex flex-wrap items-center justify-between px-6 pt-6">
                            ...
                            <div className="flex items-center gap-2.5 md:gap-3 2xl:gap-4 mt-3 md:mt-0">
                                <div className="relative 2xl:w-60 md:w-52 w-32">
                                    ...
                                    />
                                    <input
                                        className="w-full rounded-xl border border-[#E2E8F0] bg-white py-1.5 md:py-2 pl-11 pr-4 text-[14px] outline-none focus:border-[#257BFC] overflow-hidden"
                                        placeholder="Search..."
                                        value={searchQuery}
                                ...
                                <button className="flex items-center justify-center gap-2 rounded-xl border border-[#E2E8F0] bg-white px-4 py-2 text-[14px] font-semibold text-[#344054] transition hover:bg-neutral-50 overflow-hidden">
                                ...
                                <div className="overflow-x-auto">
                                    <table className="min-w-[1000px] w-full text-left border-collapse">
                                        <thead className="bg-[#F8F9FC]">
                                            <tr>
                                                <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pl-4 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E] rounded-l-lg">Employee</th>
                                                <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E]">Department</th>
                                                <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E]">Gross Pay</th>
                                                <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E]">Deductions</th>
                                                <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E]">Net Pay</th>
                                                <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E] rounded-r-lg text-center">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody className="bg-white">
                                            {filteredEmployees.map((emp) => (
                                                <tr key={emp.id} className="group transition-colors hover:bg-neutral-50 border-b border-[#E2E8F0] last:border-none">
                                                    ...
                                                    <td className="px-4 py-4 sm:px-6 text-[13px] sm:text-[14px] font-normal text-neutral-900">{emp.gross}</td>
                                                    <td className="px-4 py-4 sm:px-6 text-[13px] sm:text-[14px] font-normal text-neutral-900">{emp.deductions}</td>
                                                    <td className="px-4 py-4 sm:px-6 text-[13px] sm:text-[14px] font-normal text-neutral-900">{emp.net}</td>
