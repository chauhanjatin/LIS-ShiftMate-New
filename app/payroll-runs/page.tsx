                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-[1000px] w-full text-left border-collapse">
                                    <thead className="bg-[#F8F9FC]">
                                        <tr>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pl-4 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E] rounded-l-lg">Payroll Period</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E]">Pay Group</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E]">Pay Date</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E]">Total Payroll Cost</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[12px] sm:text-[16px] font-medium text-[#2E334E] text-center">Status</th>
                                    ...
                                    <tbody className="bg-white">
                                        {filteredRuns.map((run) => (
                                            <tr key={run.id} className="group transition-colors hover:bg-neutral-50 border-b border-[#E2E8F0] last:border-none">
                                                <td className="px-4 py-6 sm:px-6 text-[13px] sm:text-[14px] font-normal text-[#2E334E]">{run.period}</td>
                                                <td className="px-4 py-6 sm:px-6 text-[13px] sm:text-[14px] font-normal text-[#2E334E]">{run.group}</td>
                                                <td className="px-4 py-6 sm:px-6 text-[13px] sm:text-[14px] font-normal text-[#2E334E]">{run.date}</td>
                                                <td className="px-4 py-6 sm:px-6 text-[13px] sm:text-[14px] font-normal text-[#2E334E]">{run.cost}</td>
            ...
            {isAddModalOpen && (
                <div className="fixed inset-0 z-80 flex items-center justify-center bg-black/40 p-4">
                    <div className="w-full max-w-[620px] overflow-hidden rounded-3xl bg-white shadow-2xl max-h-[90vh] flex flex-col">
                        <div className="flex items-center justify-between border-b border-[#E2E8F0] px-8 py-6 shrink-0">
                            ...
                            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mb-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="h-[52px] w-full rounded-2xl border border-[#E2E8F0] bg-white px-4 pr-12 text-[14px] text-[#344054] outline-none transition focus:border-[#257BFC] overflow-hidden"
                                        />
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        className="h-[100px] w-full resize-none rounded-2xl border border-[#E2E8F0] p-4 text-[14px] outline-none transition focus:border-[#257BFC]"
                                    />
                                </div>
                            </div>
