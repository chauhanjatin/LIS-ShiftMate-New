              ...
              <div className="flex flex-wrap lg:flex-nowrap items-center 3xl:gap-3 xl:gap-6 gap-3 w-full md:w-auto">
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Search..."
                    className="w-[360px] md:w-[375px] lg:w-[150px] xl:w-[360px] h-10 pl-10 pr-4 rounded-xl border border-neutral-200 text-[14px] outline-none focus:border-[#257BFC] transition-colors"
                  />
