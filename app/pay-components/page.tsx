...
export default function PayComponentsPage() {
    ...
    const [componentToEdit, setComponentToEdit] = useState<number | null>(null);
    ...
    const handleEditSave = () => {
        if (!validateForm() || componentToEdit === null) return;
        setComponents(components.map(c => c.id === componentToEdit ? { ...c, ...formData } : c));
        setIsEditModalOpen(false);
        setComponentToEdit(null);
        // Toast is optional, we could use the same or different message
    };
    ...
    const openEditModal = (comp: PayComponent) => {
        setFormData({
            name: comp.name,
            type: comp.type,
            taxable: comp.taxable,
            pensionable: comp.pensionable,
            niApplicable: comp.niApplicable
        });
        setErrors({});
        setComponentToEdit(comp.id);
                ...
                <div className="rounded-xl bg-white shadow-sm overflow-hidden">
                    <div className="flex flex-wrap items-center justify-between md:px-6 px-4 pt-4 md:pt-6">
                        ...
                        <div className="flex flex-wrap items-center gap-2.5 md:gap-3 2xl:gap-6 mt-3 md:mt-0">
                            <div className="relative 2xl:w-75 lg:w-60 w-full">
                                <Image
                                    src={searchIcon}
                                    alt="Search"
                                    width={20}
                            ...
                            <button onClick={openAddModal} className="flex items-center gap-1 md:gap-2 rounded-xl cursor-pointer bg-[#257BFC] px-3 py-2 lg:px-5 md:py-2.5 text-[12px] lg:text-[16px] font-semibold text-white transition hover:bg-blue-600">
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-[1000px] w-full text-left border-collapse">
                                    <thead className="bg-[#F8F9FC]">
                                        <tr>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pl-4 pr-4 text-[14px] md:text-[16px] font-normal text-[#111827] rounded-l-lg">Component Name</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[14px] md:text-[16px] font-normal text-[#111827]">Type</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[14px] md:text-[16px] font-normal text-[#111827] text-center">Taxable</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[14px] md:text-[16px] font-normal text-[#111827] text-center">Pensionable</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[14px] md:text-[16px] font-normal text-[#111827] text-center">NI Applicable</th>
                                            <th className="border-b border-[#E2E8F0] px-4 py-[10px] sm:px-6 pr-4 text-[14px] md:text-[16px] font-normal text-[#111827] rounded-r-lg">Action</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <td className="px-4 py-4 sm:px-6">
                                                    <div className="flex items-center gap-3">
                                                        <button 
                                                            ...
                                                            className="cursor-pointer text-neutral-400 transition-colors hover:text-[#257BFC]"
                                                        >
                                                            <Image
                                                                src={editIcon}
                                                                alt="Edit"
                ...
                isAddModalOpen && (
                    <div className="fixed inset-0 z-80 flex items-center justify-center bg-black/40 p-4">
                        <div className="w-full max-w-[620px] overflow-hidden rounded-3xl bg-white shadow-2xl">
                            <div className="flex items-center justify-between border-b border-[#E2E8F0] 2xl:px-8 md:px-6 px-4 2xl:py-6 py-4">
                            ...
                            <div className="2xl:px-8 md:px-6 px-4 2xl:py-6 md:py-4 py-2">
                                ...
                                <div className="lg:mt-12 mt-10 flex items-center justify-end md:gap-4 gap-2">
                                    <button
                                        onClick={() => setIsAddModalOpen(false)}
                                        className="md:h-[48px] h-[40px] rounded-xl border border-[#101828] md:px-8 px-4 md:text-[15px] text-[12px] font-semibold text-[#101828] transition hover:bg-neutral-100 cursor-pointer"
                                    >
                                        Cancel
                                    </button>

                                    <button onClick={handleAdd} className="md:h-[48px] h-[40px] rounded-xl bg-[#257BFC] md:px-8 px-4 md:text-[15px] text-[12px] font-semibold text-white transition hover:bg-blue-600 cursor-pointer">
                                        Add Pay Component
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="w-full max-w-[620px] overflow-hidden rounded-3xl bg-white shadow-2xl">
                            ...
                            <div className="2xl:px-8 md:px-6 px-4 2xl:py-6 md:py-4 py-2">
                                ...
                                <div className="lg:mt-12 mt-10 flex items-center justify-end md:gap-4 gap-2">
                                    ...
                                    <button onClick={handleEditSave} className="md:h-[48px] h-[40px] rounded-xl bg-[#257BFC] md:px-8 px-4 md:text-[15px] text-[12px] font-semibold text-white transition hover:bg-blue-600 cursor-pointer">
                                        Add Pay Component
                                    </button>
                                </div>
                            </div>
...

            {
                isDeleteModalOpen && (
                    <div className="fixed inset-0 z-80 flex items-center justify-center bg-black/50 p-4">
                        <div className="w-full max-w-[340px] rounded-xl bg-white p-6 shadow-xl animate-in fade-in zoom-in-95 duration-200">
                            <div className="mb-6 flex flex-col items-center text-center">
                                <div className="mb-4 flex items-center justify-center rounded-xl p-[9px] bg-red-100">
                                    <Image src={deleteIcon} alt="Delete" width={42} height={42} className="text-red-600" />
                                </div>
                                <p className="text-[16px] font-medium text-[#111827]">Are you sure you want to delete "Basic Salary"?</p>
                            </div>
